        ...
        <ScrollView>
            ...
            <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 25, marginHorizontal: 25}}>
                ...
                <View style={[styles.container, styles.row, {alignSelf: 'flex-end', columnGap: 10, backgroundColor: '#0B666A', justifyContent: 'space-evenly'}]}>
                    ...
                    <Text style={[TextStyles.body1, {color: 'white'}]}>357 points</Text>
                </View>
            </View>
            {/* list of rewards */}
            ...
            <Reward place="7th Place" name="Nama Lengkap" nim="16452337" color='FFA40B' boxColor='rgba(11, 102, 106, 0.1)'/>
            <Reward place="8th Place" name="Nama Lengkap" nim="18221000" color='FFA40B' boxColor='rgba(11, 102, 106, 0.1)'/>
        </ScrollView>
        {/* navbar */}
        <NavbarPoin/>
    </View>
